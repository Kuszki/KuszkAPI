...
KuszkAPI::Core::Script<tnResult, tnParam>::Script(FExecute fExeFun, FPrepare fPreFun)
{
      fExe = fExeFun;
      fPre = fPreFun;
}
...
template<typename tnResult, typename tnParam>
void KuszkAPI::Core::Script<tnResult, tnParam>::SetAction(FExecute fExeFun, FPrepare fPreFun)
{
...
tnResult KuszkAPI::Core::Script<tnResult, tnParam>::operator() (Containers::Strings sCommand, tnParam tParam) const
{
      ...
      tLast = fExe(uCode, sCommand, tParam);
      return tLast;
}
