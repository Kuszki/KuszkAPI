...
Forms::Calendar& KuszkAPI::Forms::Calendar::Create(int iXPos, int iYPos, const DateTime::Date& dDate, unsigned uStyl, unsigned uExStyl, const Containers::String& sClass)
{
     Destroy();
