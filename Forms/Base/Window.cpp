...
void KuszkAPI::Forms::Window::SetPos(const TCord& tPos)
{
      SetPos(tPos.X, tPos.Y);
}

KuszkAPI::Forms::Window::TCord KuszkAPI::Forms::Window::GetPos(void) const
{
      TCord tCord;
      POINT pTmp;
...
KuszkAPI::Forms::Window::TCord KuszkAPI::Forms::Window::GetSize(void) const
{
      TCord tTmp;
      RECT rTmp;
